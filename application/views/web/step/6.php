  ...
  <div class="panel-body">
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="nama_sekolah" class="form-control bg-blue" placeholder="Nama Sekolah" maxlength="100" data-parsley-group="block6" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-nama_sekolah"]' required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih jenjang sekolah sebelumnya" name="jenjang_sekolah" data-parsley-group="block6" data-parsley-errors-container='div[id="error-jenjang_sekolah"]'>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih status sekolah sebelumnya" name="status_sekolah" data-parsley-group="block6" data-parsley-errors-container='div[id="error-status_sekolah"]'>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
        <input type="text" name="npsn_sekolah" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="10" placeholder="NPSN Sekolah sebelumnya" data-parsley-group="block6" data-parsley-errors-container='div[id="error-npsn_sekolah"]'>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih lokasi sekolah sebelumnya" name="lokasi_sekolah" data-parsley-group="block6" data-parsley-errors-container='div[id="error-lokasi_sekolah"]'>
