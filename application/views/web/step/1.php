<div class="panel">
  ...
  <div class="panel-body">
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="file" name="dokumen_kk" class="form-control bg-blue" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-dokumen_kk"]' accept="application/pdf, image/*" required>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Akte Kelahiran<span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon">
        <input type="file" name="dokumen_akte_kelahiran" class="form-control bg-blue" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-dokumen_akte_kelahiran"]' accept="application/pdf, image/*" required>
        <i class="fa fa-file" style="margin-left:15px; margin-top:4px;"></i>
        <div id="error-dokumen_akte_kelahiran" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
      </div>
    </div>

    <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">SKL<span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon">
        <input type="file" name="dokumen_skl" class="form-control bg-blue" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-dokumen_skl"]' accept="application/pdf, image/*" required>
        <i class="fa fa-file" style="margin-left:15px; margin-top:4px;"></i>
        <div id="error-dokumen_skl" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
      </div>
    </div>
