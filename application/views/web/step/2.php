...
<div class="panel">
  ...
  <div class="panel-body">
    ...
    <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Lampiran Dok. Nilai Raport <span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon">
        <input type="file" name="dok_raport" class="form-control bg-blue" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-dok_raport"]' accept="application/pdf, image/*" required>
        <i class="fa fa-file" style="margin-left:15px; margin-top:4px;"></i>
        <div id="error-dok_raport" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
      </div>
    </div>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        ...
        <i class="fa fa-book" style="margin-left:15px;"></i>
        <div id="error-nilai_prestasi" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
      </div>
    </div>
    <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Lampiran Dok. Nilai Prestasi <span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon">
        <input type="file" name="dok_prestasi" class="form-control bg-blue" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-dok_prestasi"]' accept="application/pdf, image/*" required>
        <i class="fa fa-file" style="margin-left:15px; margin-top:4px;"></i>
        <div id="error-dok_prestasi" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
      </div>
    </div>
