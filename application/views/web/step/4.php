<div class="panel">
  ...
  <div class="panel-body">
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="nama_ayah" oninput="copy()" id ="nama_ayah" class="form-control bg-blue" placeholder="Nama Ayah Kandung" maxlength="100" data-parsley-group="block3" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-nama_ayah"]' required>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
        <input type="text" oninput="copy1()" name="nik_ayah" id="nik_ayah" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="16" placeholder="NIK Ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-nik_ayah"]' required>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
        <input type="text" oninput="copy2()" id ="thn_lahir_ayah" name="th_lahir_ayah" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="16" placeholder="Tahun lahir Ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-th_lahir_ayah"]' required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select  id = "status_ayah" class="form-control bg-blue class" data-placeholder="Status Ayah" name="status_ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-status_ayah"]' required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select  id="pekerjaan_ayah" class="form-control bg-blue class" data-placeholder="Pilih Pekerjaan Ayah" name="pekerjaan_ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-pekerjaan_ayah"]' required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select id="penghasilan_ayah" class="form-control bg-blue class" data-placeholder="Pilih Penghasilan Ayah" name="penghasilan_ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-penghasilan_ayah"]' required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select id="pendidikan_ayah" class="form-control bg-blue class" data-placeholder="Pilih Pendidikan Ayah" name="pdd_ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-pdd_ayah"]' required>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" id="f1" name="nama_wali" class="form-control bg-blue" placeholder="Nama wali " maxlength="100" data-parsley-group="block3" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-nama_wali"]'>
        <i class="fa fa-user" style="margin-left:15px;"></i>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
        <input type="text" id="f2" name="nik_wali" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="16" placeholder="NIK wali" data-parsley-group="block3" data-parsley-errors-container='div[id="error-nik_wali"]'>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
        <input type="text" id="f3" name="th_lahir_wali" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="16" placeholder="Tahun lahir wali" data-parsley-group="block3" data-parsley-errors-container='div[id="error-th_lahir_wali"]'>
  ...
  <div class="form-group">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Status Ayah <span class="text-danger">*</span></label>
      <div class="col-sm-9" style="margin-top:3px;">
        <select  id = "status_ayah" class="form-control bg-blue class" data-placeholder="Status Wali" name="status_ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-status_ayah"]' required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        ...
        <select type="text" name="" id ="f4" class="form-control bg-blue class" data-placeholder="Pilih Pekerjaan wali" name="pekerjaan_wali" data-parsley-group="block3" data-parsley-errors-container='div[id="error-pekerjaan_wali"]'>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select id="f5" class="form-control bg-blue class" data-placeholder="Pilih Penghasilan Ayah" name="penghasilan_wali" data-parsley-group="block3" data-parsley-errors-container='div[id="error-penghasilan_wali"]'>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select id="f6" class="form-control bg-blue class" data-placeholder="Pilih Pendidikan wali" name="pdd_wali" data-parsley-group="block3" data-parsley-errors-container='div[id="error-pdd_wali"]'>
