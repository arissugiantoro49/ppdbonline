              ...
              foreach ($v_siswa->result() as $baris) { ?>
                <tr>
                  ...
                  <td align="center" style="white-space: nowrap;">
                    ...
                    <a href="panel_admin/download_dokumen/<?php echo $baris->no_pendaftaran; ?>" class="btn btn-default btn-xs" title="Download Dokumen" target="_blank"><i class="icon-box-add"></i></a>
                    ...
                    <?php } else { ?>
                      <a href="panel_admin/verifikasi/cek/<?php echo $baris->no_pendaftaran; ?>" class="btn btn-warning btn-xs" title="Batal Verifikasi" onclick="return confirm('Apakah Anda yakin?')"><i class="icon-cross3"></i></a>
                    <?php } ?>
                    <a href="panel_admin/verifikasi/hapus/<?php echo $baris->no_pendaftaran; ?>" class="btn btn-danger btn-xs" title="Hapus" onclick="return confirm('Apakah Anda yakin?')"><i class="icon-bin"></i></a>
                  </td>
