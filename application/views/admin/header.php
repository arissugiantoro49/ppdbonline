...
<head>
	...
	<title><?php echo $judul_web; ?> - PPDB MTs Umar Zahid Semelo</title>
...
<body class="navbar-bottom">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="panel_admin/">PPDB <label class="label label-primary">MTs Umar Zahid Semelo</label></a>
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'verifikasi' or $sub_menu == 'edit_materi') { echo 'active';} ?>">
								<a href="panel_admin/perhitungan_moora"><i class="icon-file-check"></i> <span><b>DATA PERHITUNGAN</b></span></a>
								</li> 
